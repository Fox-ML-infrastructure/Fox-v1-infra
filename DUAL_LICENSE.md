# Fox ML Infrastructure - Dual License

Fox ML Infrastructure is dual-licensed under two distinct license options:
...
- You must share source code of any modifications when providing network services
- Full terms available in the `LICENSE` file

**When to use:** Non-commercial academic research, personal projects, open-source contributions

## License Option 2: Commercial License

**For:** Any revenue-generating or organizational use

**Terms:**
- Required for internal company use, trading, forecasting, modeling, optimization, operational analytics
...
- Your use is purely academic or personal research
- Your use is non-commercial
- You are willing to comply with AGPL source code disclosure requirements
...
- `legal/LICENSING.md` - Additional licensing information
