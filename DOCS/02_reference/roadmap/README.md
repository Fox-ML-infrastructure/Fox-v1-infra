...
- **Winter 2025** — Full TRAINING pipeline operational, GPU acceleration enabled, SST compliance achieved
- See [Current Status (2025-12-12)](2025-12-12.md) for detailed status
