...
This document outlines enforcement, verification, and termination conditions related to
the Universal Additional Permission in EXCEPTION.md.

---

## 1. Enforcement Authority

The copyright holder (Jennifer Lewis) retains full authority to:

- approve or deny institutional use,

- request compliance documentation,

- revoke additional permission,

- enforce AGPL compliance,

- issue legal notices of violation.

---

## 2. Verification Rights
...
Failure to respond = automatic termination.
...
Upon termination, the institution must:

1. Cease all internal, financial, analytical, operational, or strategic use.

2. Remove the software from internal compute systems.

3. Delete all operational models, forecasts, or derivatives created for institutional use.

4. Retain AGPL rights only for private, non-institutional use.

---

## 5. Intent Override (Anti-Loophole Rule)
...
**Jennifer Lewis**  
Primary Maintainer & Copyright Holder  

(Include institution name, department, nature of violation, and evidence.)
