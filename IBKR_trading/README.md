...
Production-ready framework for intraday trading with 16 machine learning models across 5 horizons (5m, 10m, 15m, 30m, 60m).
...
System uses `config/ibkr_enhanced.yaml` for all configuration. Key sections:
...
- Live Trading: System designed for live trading with real money
- Risk Management: Test thoroughly in paper trading first
